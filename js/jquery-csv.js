        ...
        csv.replace(match, function (m0) {
          ...
          switch (state) {
            ...
            case 0:
              ...
              // null last value CRLF eol
              if (/^\r\n/.test(m0)) {
                endOfValue();
                endOfEntry();                  
                break;
              }
              // null last value mac end of line
              if (/^\r$/.test(m0)) {
                endOfValue();
                endOfEntry();   
                break;
            ...
            case 2:
              ...
              // end of entry CRLF
              if (/^\r\n/.test(m0)) {
                // dans mods this is a /r/n as far as I can tell which should just be a new line
                endOfValue();
                endOfEntry();                   
                break;
              }
              // end of entry mac end of line
              if (/^\r$/.test(m0)) {
                endOfValue();
                endOfEntry();                                     
                break;
